 ...
 * @file uart.c
 *
 * @brief This file is the main file that programs the necessary functions to
 * communicate over UART1
 *
...
void uart_sendStr(char data[]){
    ...
    //While not the null character
    while(data[i] != 0){
        //Send the character over UART
